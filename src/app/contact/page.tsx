...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Tek Dünyası. Let's discuss your web development project and create something amazing together.",
};
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-text-gray text-sm hover:text-green-600 transition-colors"
                    >
                      Chat on WhatsApp
                    </a>
                  </div>
